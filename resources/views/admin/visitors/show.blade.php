            ...
            <div class="col-md-6">
                ...
                <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea class="form-control @error('remarks') is-invalid @enderror" name="remarks" rows="3" readonly>{{$visitor->remarks}}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="created_at" class="col-sm-3 col-form-label">Exit Time</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="created_at" value="{{$visitor->updated_at}} ({{$visitor->updated_at->diffForHumans()}})" readonly>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-3 col-sm-9">
                            ...
                            <button type="button" class="btn btn-secondary" onclick="window.location='{{ URL::route('admin.visitors.index') }}'">Back</button>
                          </div>
                        </div>
